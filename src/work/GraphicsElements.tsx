...
export const GraphicsTextContent = styled.div`
  width: 100%;
...
export const GraphicsDetailSubtitle = styled.h3`
  font-size: 1.5rem;
  margin-bottom: 1rem;
  color: ${({ theme }) => theme.colors.headingText};
`;

export const GraphicsDetailParagraph = styled.p`
  font-size: 1rem;
  color: ${({ theme }) => theme.colors.text};
  margin-bottom: 1rem;
  line-height: 1.6;
...
export const GraphicsFullscreenOverlay = styled.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
export const GraphicsFullscreenImage = styled.img`
  max-width: 90%;
  max-height: 90%;
  object-fit: contain;
`;

export const GraphicsCloseButton = styled.button`
  position: absolute;
  top: 20px;
  right: 20px;
  background: none;
