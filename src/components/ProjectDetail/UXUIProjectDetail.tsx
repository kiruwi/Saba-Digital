  ...
  return (
    <UXUIDetailContainer>
        ...
        <UXUIHeroInner>
          ...
          {project.id !== 'ufanisi-resort' || isMobile ? (
            <>
              ...
              />
              <UXUIHeroOverlay>
                <UXUIHeroTitle>{project.title}</UXUIHeroTitle>
              </UXUIHeroOverlay>
            </>
          ) : (
            <UXUIHeroTitleBand>
      ...
      <UXUIDetailHeader>
        <UXUIDetailDescription>
          ...
          {project.fullDescription2 && (
            <UXUIDetailParagraph $hasTopMargin>
              {project.fullDescription2}
            </UXUIDetailParagraph>
          )}
          ...
          {project.fullDescription3 && Array.isArray(project.fullDescription3) && project.fullDescription3.map((section, index) => {
            ...
            return (
              <UXUISectionMd key={`section-${index}`}>
      ...
      <UXUISection>
        ...
        <UXUIList>
          {project.features && project.features.map((feature, index) => (
            <UXUIListItem key={index}>{feature}</UXUIListItem>
          ))}
        </UXUIList>
      </UXUISection>
      ...
      <UXUISection>
        ...
        <UXUIDetailParagraph>{project.tools && project.tools.join(', ')}</UXUIDetailParagraph>
      </UXUISection>
      
      <UXUISection>
        <UXUIHeading>Year</UXUIHeading>
        <UXUIDetailParagraph>{project.year}</UXUIDetailParagraph>
      </UXUISection>
    </UXUIDetailContainer>
  );
};
